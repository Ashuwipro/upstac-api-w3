...
public class ConsultationController {
    ...
    public List<TestRequest> getForDoctor()  {
        ...
        //returning the list of test requests assigned to current logged in doctor
    ...
    public TestRequest assignForConsultation(@PathVariable Long id) {
        ...
        try {
            ...
            //assigning a particular test request to the current logged in doctor and returning it.
    ...
    public TestRequest updateConsultation(@PathVariable Long id,@RequestBody CreateConsultationRequest testResult) {
        ...
        try {
            ...
            //updating the result of current test request id with doctor comments and returning it
